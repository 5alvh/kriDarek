...
public class PropertyServiceImpl implements PropertyService {
    ...
    @Override
    public Page<PropertyGetDTO> searchProperties(PropertySearchDTO searchDTO, Pageable pageable, Long userId) {
        ...
        return properties.map(property -> {
            PropertyGetDTO dto = propertyMapper.toDTO(property);
            if (userId != null) {
    ...
    @Override
    public PropertyGetDTO getPropertyById(Long id, Long userId) {
    ...
    @Override
    public PropertyGetDTO createProperty(PropertyCreateDTO propertyDTO, Long ownerId) {
    ...
    @Override
    public List<PropertyGetDTO> getMyProperties(Long ownerId) {
